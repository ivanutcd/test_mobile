...
{
    public class RestaurarVersionFormularioCommandHandler : ICommandHandler<RestaurarVersionFormularioCommand>
    {
        ...
        public RestaurarVersionFormularioCommandHandler(
        ...
        public async Task Handle(RestaurarVersionFormularioCommand command)
        {
