    ...
    public class TablaCargaTrabajoDetalle(IOptions<DbSettings> dbSettings) : Migration
    {
        ...
        public override void Up()
        {
            Create
                ...
                .NotNullable()
                .WithColumn("EstadoCaptura")
                .AsString(50)
                .NotNullable()
                .WithDefaultValue("pendiente")
                .WithColumn("EstadoSincronizacion")
                .AsString(50)
                .NotNullable()
                .WithDefaultValue("pendiente")
                ...
                .AsString(200)
                .Nullable()
                .WithColumn("CargaTrabajoId")
                .AsGuid()
                .NotNullable()
                .WithAuditableFields();

            Create
                .ForeignKey($"FK_{TableName}_CargaTrabajo")
                .FromTable(TableName)
                .InSchema(schema)
                .ForeignColumn("CargaTrabajoId")
                .ToTable("CargaTrabajo")
                .InSchema(schema)
                .PrimaryColumn("Id");
        }
