...
namespace utcd.cobro_prejuridico.Data.Migrations.Formulario
{
    ...
    public class AgregarCampoFormularioBaseId(IOptions<DbSettings> dbSetting) : Migration
    {
        public override void Up()
        {
            ...
            Delete.Column("FormularioOrigenId").FromTable("Formulario").InSchema(schema);
            ...
            Create
                .ForeignKey("FK_Formulario_FormularioBaseId")
                .FromTable("Formulario")
                .InSchema(schema)
                .ForeignColumn("FormularioBaseId")
                .ToTable("Formulario")
                .InSchema(schema)
                .PrimaryColumn("Id");
        }
        ...
        public override void Down()
        {
            ...
            Delete.Column("FormularioBaseId").FromTable("Formulario").InSchema(schema);
